...
def main() -> int:
    ...
    planisphere_fragments = {
        ...
        # with the other unreferenced create-screen helpers (maintainer ruling, 2026-09-13). The live
        # preview fill is the square-map alpha handled by the planisphere renderer.
    }
