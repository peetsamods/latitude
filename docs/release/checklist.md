...
- [ ] PUBLISH (manual, Julia): GitHub release + Modrinth upload of `build/libs/latitude-1.4.0+26.1.2.jar` (1,460,266 bytes, **SHA-256 `8a01f69c99513ed0011924945a3df0a8c5f28515203ac8adc93e82079824e015`**, built from `2deab50e`), Modrinth version listing, close any tracking issue. Mirror the 1.3.0 checklist pattern.
