...
public class LatitudeHudStudioScreen extends Screen {
    ...
    protected void init() {
        ...
        this.wCompassStyle = this.addDrawableChild(CyclingButtonWidget.<CompassHudConfig.CompassStyle>builder(v -> Text.literal(v == CompassHudConfig.CompassStyle.ANALOG ? "Analog" : "Digital"))
        ...
        if (analog) {
            ...
            y += rowH + rowGap;
            this.wCompassAnalogTheme = this.addDrawableChild(CyclingButtonWidget.<CompassHudConfig.AnalogCompassTheme>builder(v -> Text.literal(themeLabel(v)))
                    .values(CompassHudConfig.AnalogCompassTheme.values())
                    .initially(cfg.analogTheme)
        ...
        if (analog) {
            this.wCompassAnalogShowLatitude = this.addDrawableChild(CyclingButtonWidget.<Boolean>builder(v -> Text.literal(v ? "ON" : "OFF"))
                    .values(true, false)
                    .initially(Boolean.TRUE.equals(cfg.analogShowLatitude))
        ...
        this.wZoneDisplay = this.addDrawableChild(CyclingButtonWidget.<Boolean>builder(v -> Text.literal(v ? "ON" : "OFF"))
                .values(true, false)
                .initially(cfg.displayZoneInHud)
        ...
        this.wZoneFollow = this.addDrawableChild(CyclingButtonWidget.<Boolean>builder(v -> Text.literal(v ? "FOLLOW" : "DETACH"))
                .values(true, false)
                .initially(cfg.zoneFollowsCompass)
