...
final class CompassDialRenderer {
    ...
    private static void drawNorthLabel(GuiGraphicsExtractor ctx, Font font, int cx, int cy, int radius, DialColors colors) {
        ...
        // S34 revert (owner: "put the compass back to how it was"): the S33 red/outlined N is retired; back to
        // TEST 119's settled look -- vanilla drop shadow plus the brightness lift, in the theme's needle tone.
