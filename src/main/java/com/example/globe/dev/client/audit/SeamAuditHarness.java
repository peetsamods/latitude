 ...
 *       {@link MinecraftClient#scheduleStop()}.</li>
 * </ol>
 *
...
public final class SeamAuditHarness {
    ...
    private static void applyClientSettings(MinecraftClient client) {
    ...
    private static void restoreClientSettings(MinecraftClient client) {
        GameOptions options = client.options;
